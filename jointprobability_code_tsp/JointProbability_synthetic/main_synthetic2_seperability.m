...
F_true = 5; %Rank of the matrix factorization
...
%No of samples
n_items_list=[100,10000,100000,1000000];
...
for s = 1:n_sim
    %% Setting up
    %True Parameters
    [A_true,l_true]  = gen_PMF_factors_dirich_with_sep(I,F_true,eps);    % True factors
   ...
   [rec_error1(s,ii),mre_error1(s,ii),A_est_p,l_est_p] = getMSE(A_est,l_est,A_true,l_true,1);
   ...
   %Resolve permutation ambiguity
   [rec_error2(s,ii),mre_error2(s,ii),A_est_KL_p,l_est_KL_p] = getMSE(A_est_KL_m,l_est_KL_m,A_true,l_true,1);
   ...
   %% CNMF-EM
    ...
    %Resolve permutation ambiguity
    [rec_error3(s,ii),mre_error3(s,ii),A_est_p,l_est_p] = getMSE(A_est_spa_em,l_est_spa_em,A_true,l_true,1);
    ...
    %Resolve permutation ambiguity
    [rec_error4(s,ii),mre_error4(s,ii),A_est_p,l_est_p] = getMSE(A_est_rand_em,l_est_rand_em,A_true,l_true,1);
   ...
   disp('Running CTD Algorithm....');
    ...
    %Resolve permutation ambiguity
   [rec_error5(s,ii),mre_error5(s,ii),A_est_LS_p,l_est_LS_p] = getMSE(A_est_LS,l_est_LS,A_true,l_true,1);
...
% 
  ...
  [rec_error7(s,ii),mre_error7(s,ii),A_est_p,l_est_p] = getMSE(A_est_mle_ad,l_est_mle_ad,A_true,l_true,1);
   ...
   %% Yeredor ML AO
    ...
    %Resolve permutation ambiguity
    [rec_error8(s,ii),mre_error8(s,ii),A_est_p,l_est_p] = getMSE(A_est_mle_em,l_est_mle_em,A_true,l_true,1);
...
Nitems = {'N=1000';'N=10000';'N=100000';'N=1000000';'time(s)'};
 ...
 T = table(CNMF_SPA,CNMF_OPT,SPA_EM,RAND_EM,CTD,CTD_EM,MLE_AD,MLE_EM,...
    'RowNames',Nitems);
writetable(T,'table_N_5_I_10_F_5_M_3_p50_eps_0_3.csv','WriteRowNames',true)
...
save data_N_5_I_10_F_7_M_3_p50_eps_0_3
%     figure(3)
