...
for s = 1:n_sim
    ...
    [trainIndices,validIndices,testIndices] = dividerand(rows,0.4,0.3,0.3);
    ...
    if(LINEAR_REG)
        a=tic;
        LinearReg_Model = fitlm(Data_train,Labels_train);
...
writetable(T,'table_nursery.csv','WriteRowNames',true)
save data_nursery