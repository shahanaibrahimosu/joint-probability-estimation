...
%Test Variables
[Data,I]    = LoadDataset_mushroom();
[rows, col] = size(Data);
N           = length(I);
F_list_SPA=[5,10,15];
F_list_SPA1=[5,10,15];
F_list_Tensor=[5,10,15];
...
rows = {'Accuracy';'STD_Accuracy';'time(s)'};
 ...
 T = table(CNMF_SPA,CNMF_OPT,SPA_EM,CTD,CTD_EM,SVM,LINEAR_REGRESSION,NNET,SVM_RBF,NAIVE_BAYES,...
    'RowNames',rows);

writetable(T,'table_mushroom.csv','WriteRowNames',true)
save data_mushroom